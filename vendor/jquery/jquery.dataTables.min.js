...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"<i class='icon ion-ios-arrow-forward'></i>",sPrevious:"<i class='icon ion-ios-arrow-back'></i>"},sEmptyTable:"No data available in table",sInfo:"_START_-_END_ of _TOTAL_",sInfoEmpty:"0-0 of 0",sInfoFiltered:"(filtered from _MAX_ total entries)",
