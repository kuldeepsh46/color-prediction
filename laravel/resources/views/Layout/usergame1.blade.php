...
<head>
    ...
    <!--====== Title ======-->
    <title>Dreamplay - Online Sports Betting</title>
    ...
    <link rel="stylesheet" href="css/_grid-framework.scss" />
    ...
    <!-- ====== Chat_bot CSS ====== -->
    <link rel="stylesheet" href="css/chatbot/chat.css" />
    <link rel="stylesheet" href="css/chatbot/home.css" />
    <!-- <link rel="stylesheet" href="css/chatbox/bootstrap.min.css" /> -->
...
<body class="dark-bg-main">
                                        ...
                                        <div class="checks-bg">
                                            <div class="pretty p-svg p-thick">
                                                ...
                                                <div class="state">
                                                    ...
                                                    <label>I confirm that I am of legal age and agree with the <a>game rules</a></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <input type='hidden' name='profileImage' value='{{"/images/avtar/av-".rand(1,72).".png"}}' />
                                    <button type="submit"
                                        class="btn orange-btn md-btn custm-btn-2 mx-auto mt-3 mb-0 registerSubmit"
                                        id="register_via_email">REGISTER</button>
    ...
    <!--====== Comming Soon ======-->
    <div class="modal fade l-modal" id="coming-modal" tabindex="-1" aria-labelledby="coming-modal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div style="width:100%;">
                    <img src="images/coming_soon.gif" style="width:300px;">
                </div>
                
                <div class="login-footer mt-1">
                    <button class="btn orange-btn md-btn custm-btn-2 mx-auto mt-1 mb-2" data-bs-dismiss="modal" aria-label="Close">Close</button>
                </div>
            </div>
        </div>
    </div>
