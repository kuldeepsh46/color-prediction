...
@section('content')
    <div class="deposite-container" style="margin-top:150px;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <div class="pay-options">
                        ...
                        <p style="color: black;text-align: center;font-size: 12px;background: #00d432;padding: 8px;border: solid 1px;border-radius: 10px;"> Note : Withdrawal request placed after 12:00 P.M. will be executed by 10:00 A.M. on next day.</p>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-1">
                    <form class="login-form text-center" action="/insert/withdrawal" method="post" id="withdraw_form">
                        ...
                        <input type="hidden" name="min_withdraw_amount" id="min_withdraw_amount" value="{{$minAmt}}">
                       
                        <div>
                            <label for="amount" class="form-label text-dark">Available Balance </label>
                            <div class="login-controls">
                                <label for="amount">
                                    <input type="text" class="form-control text-indent-0 text-center" value="{{wallet(user('id'))}}" readonly="readonly">
                                </label>
                            </div>
                        </div>
                        ...
                        <div id="account_div">
                            ...
                            <div class="login-controls">
                                <label for="account_no">
                                    <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" class="form-control text-indent-0" id="accountno"
                        ...
                        <div id="account_holder_name_div">
                            <label for="account_holder_name" class="form-label text-dark ">Account Holder Name </label>
                            <div class="login-controls">
                                <label for="account_holder_name">
                                    <input type="text" class="form-control text-indent-0" id="branchname"
                                        name="branchname" value="{{isset($bank->branchname) ? $bank->branchname : ''}}">
                                </label>
                            </div>
                            ...
                            <div class="login-controls">
                                <label for="bankname">
                                    <input type="text" class="form-control text-indent-0" id="bankname"
                                        name="bank_name" value="{{isset($bank->bankname) ? $bank->bankname : ''}}" >
                                </label>
                            </div>
                        ...
                        <div id="ifsc_code_div">
                            ...
                            <div class="login-controls">
                                <label for="ifsc_code">
                                    <input type="text" class="form-control text-indent-0" id="ifsccode"
                        ...
                        <div id="mobile_div">
                            ...
                            <div class="login-controls">
                                <label for="mobile_no">
                                    <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" class="form-control text-indent-0" id="mobile_no"
