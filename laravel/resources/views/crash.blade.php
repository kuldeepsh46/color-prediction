...
<body class="dark-bg-main">
    ...
    <div class="main-container">
        ...
        <div class="left-sidebar">
            ...
            <div  style="padding-top: 20px;" class="adSection">
            ...
            <div class="tabs-navs">
                ...
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item active" role="presentation">
                        ...
                        <button class="nav-link active" id="pills-ads-tab-all" data-bs-toggle="pill"

                            data-bs-target="#" type="button" role="tab"

                            aria-controls="pills-all-ads" aria-selected="true">All Ads</button>

                    </li>

                    <li class="nav-item" role="presentation">

                        <button class="nav-link" id="pills-ads-tab-video" data-bs-toggle="pill"

                            data-bs-target="#" type="button" role="tab"

                            aria-controls="pills-video-ads" aria-selected="false">Video Ads</button>

                    </li>
                    
                    <li class="nav-item" role="presentation">

                        <button class="nav-link" id="pills-ads-tab-image" data-bs-toggle="pill"

                            data-bs-target="#" type="button" role="tab"

                            aria-controls="pills-image-ads" aria-selected="false">Still Ads</button>

                    </li>

                    <span class="active-line" style="width:33.333%"></span>

                </ul>

            </div>
            
            <div class="imageAds" style="display: none;">
                    <div class="owl-stage-outer">
                        <div class="owl-stage" style="transform: translate3d(-894px, 0px, 0px); transition: all 0.25s ease 0s; width: 3278px;">
                            @foreach($allAds['imageAds'] as $ad)
                                <div class="owl-item" style="width: 400px; height: auto">
                                        <div class="item image" data-autoplay-timeout="11000">
                                            <img src="images/Adds/{{$ad->image}}" class="w-100">
                                        </div>
                                </div>
                            @endforeach
                        </div>
              ...
              <div class="videoAds" style="display: none;">
                    <div class="owl-stage-outer">
                        <div class="owl-stage" style="transform: translate3d(-894px, 0px, 0px); transition: all 0.25s ease 0s; width: 3278px;">
                            @foreach($allAds['videoAds'] as $ad)
                            <div class="owl-item" style="width: 400px; height: auto">
                                    <div class="item video" data-autoplay-timeout="31000">
                                        <video playsinline class="video-player" width="400px" height="auto" controls="controls" controls preload="auto" autoplay="auto-play" muted> 
                                            <source src="images/Adds/{{$ad->image}}" type="video/mp4" >
                                        </video>
                                        <div class="fullVideoLink" style="color:#fff;position: relative; font-size: 14px;text-align: right;padding: 4px 6px 0px 0;"><a href="{{$ad->adLink}}" target="_blank">
                                            <span><img src="images/watch_vid.png" alt="alternatetext" style="width:70px;height:auto;transition: revert-layer;position: relative;display: inline-flex; margin-top:-200px;"> </span> </a>
                                            <!--<img src="image/watch_vid.png" alt="alternatetext">-->
                                        </div>
                                    </div>
                            </div>
                        @endforeach
...
<!------slider end----->
            ...
            <div class="tabs-navs">
                ...
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    ...
                    <span class="active-line" style="width:50%;"></span>
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-allbets" role="tabpanel"
                        ...
                        <div class="list-data-tbl mt-2">
                            ...
                            <div class="list-body scroll-div list-body0" id="all_bets"> 
                           ...
                           <!--<div class="list-body scroll-div list-body0 " id="prev_bets"> </div>-->
                    ...
                    <div class="tab-pane fade" id="pills-mybets" role="tabpanel" aria-labelledby="pills-mybets-tab">
                        ...
                        <div class="list-data-tbl mt-2">
                            ...
                            <div class="list-body scroll-div list-body0 " id="my_bet_list">
                ...
                <div class="bet-controls">
                    ...
                    <div class="bet-control double-bet" id="main_bet_section">
                        ...
                        <div class="controls">
                            ...
                            <div class="bet-box-action" id="add_extra_bet_section_btn">
                                ...
                                <div class="cashout-block m-0">
                                    ...
                                    <div class="cashout-spinner-wrapper">
                                        ...
                                        <div class="cashout-spinner disabled">
                                            ...
                                            <div class="spinner small" style=" height: 24px; margin: 3px;">

                                                <div class="input full-width">

                                                    <input class="f-14 font-weight-bold" disabled type="text"
                                                ...
                                                <div class="text text-x">
                                                    ...
                                                    <span class="material-symbols-outlined" <span class="material-symbols-outlined" style="font-size: 14px; margin-top: 2px;">
                    ...
                    <div class="bet-control double-bet" style="display: none;" id="extra_bet_section">
                                        ...
                                        <div class="cashout-spinner disabled">
                                            ...
                                            <div class="spinner small" style=" height: 24px; margin: 3px;">
                                                ...
                                                <div class="input full-width">
                                                    ...
                                                    <input class="f-14 font-weight-bold" type="text" disabled
                                                ...
                                                <div class="text text-x">
                                                    ...
                                                    <span class="material-symbols-outlined" style="font-size: 14px; margin-top: 2px;">
    ...
    <script src="/user/aviatorold.js?v={{env('APP_VERSION')}}"></script>
     ...
     <script src="/user/aviatorbyapp.js?v={{env('APP_VERSION')}}"></script> 
        ...
        $(document).ready(function() {
            ...
            var videoElement = $(".video-player:first");
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (result.isSuccess) {
                    // document.cookie = "initialBonus=" + result.data.initialBonus;
                    // setCookie("initialBonus", result.data.initialBonus);
                    document.cookie = "initialBonus=" + result.data.initialBonus + ";" + ";path=/";
    ...
    // gamegenerate();
    generateNewGame();
    var adsHtml = $('.adSection').find('.owl-carousel').html();
    var imageAdsHtml = $('.imageAds').html();
    var videoAdsHtml = $('.videoAds').html();
    $('#pills-ads-tab-video').click(() => {
        $('.owl-carousel').empty();
        setTimeout(() => {
            $('.adSection').find('.owl-carousel').html(videoAdsHtml);
            if (window.timeoutId) {
    ...
    $('#pills-ads-tab-image').click(() => {
        $('.owl-carousel').empty();
        setTimeout(() => {
            $('.adSection').find('.owl-carousel').html(imageAdsHtml);
            if (window.timeoutId) {
                  clearTimeout(window.timeoutId);
                }
            $('.owl-carousel').owlCarousel('destroy');
    ...
    $('#pills-ads-tab-all').click(() => {
        $('.owl-carousel').empty();
        setTimeout(() => {
            $('.adSection').find('.owl-carousel').html(adsHtml);
            if (window.timeoutId) {
                  clearTimeout(window.timeoutId);
                }
            $('.owl-carousel').owlCarousel('destroy');
...
setTimeout(owlCarouselSliderCustom, 200);
    function owlCarouselSliderCustom() {
        ...
        owl.on('translated.owl.carousel', function (event) {
            ...
            var prevSlideElement = event.relatedTarget.$stage.find('.owl-item').eq(currentSlideIndex - 1);
                var prevVideo = prevSlideElement.find('video')[0];
                if (prevVideo && prevVideo.tagName.toLowerCase() === 'video') {
                    prevVideo.pause();
                }
            });
            setTimeout(() => {
                if($('.owl-item.active .item').hasClass('image')) {
                    var currentTimeout = 10500;
                } else {
                    var currentTimeout = 30500;
                }
                setTimeout(startNextSlide, currentTimeout);
            }, 200);
    }
    function startNextSlide() {
            $(".fullVideoLink").css("display", "none");
        var owl = $('.owl-carousel');
                owl.trigger('next.owl.carousel');
                var currentTimeout = $('.owl-item.active .item').data('autoplay-timeout');
                if(currentTimeout == 31000) {
                    var video = $('.owl-item.active .item video')[0];
                    video.currentTime = 0;
                    setTimeout(() => {
                        video.play();
                        video.play();
                        setTimeout(() => {
                            $(video).next(".fullVideoLink:first").css("display", "block");
                        }, 25000);
                    }, 300);
                }
                window.timeoutId = setTimeout(startNextSlide, currentTimeout);
            }
    </script>
