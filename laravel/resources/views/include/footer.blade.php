 ...
 <div class="container">
   <div class="row footer_1">
    <div class="col-md-4" style="margin-top: 20px;">
    	 <div class="footer_1i">
	   <h3><a class="text-white" href="#"><img src="images/main_logo.png" style="width: 155px; margin-top: -7px"> </a></h3>
	   <p class="mt-3"style="font-size: 14px;text-align: justify;">To give you the best player experience our support is here to give you the answer to your question. We are a dedicated and friendly team, and most important we love to help. </p>
	   <h6 class="fw-normal" style="font-size: 14px;text-align: justify;"><i class="fa fa-map-marker fs-5 align-middle col_red me-1"></i> #251, 18th Floor, Downtown Business Centre, Dubai</h6>
        <h6 class="fw-normal mt-3" style="font-size: 14px;text-align:"><i class="fa fa-envelope fs-5 align-middle col_red me-1"></i> support@dreamplay.me</h6>
		<!-- <h6 class="fw-normal mt-3 mb-0"><i class="fa fa-phone fs-5 align-middle col_red me-1"></i>  +123 123 456</h6> -->
	 </div>
	</div>


	<div class="col-md-4" style="margin-top: 20px; padding: 0 30px 0px 30px;">
	 <div class="footer_1i">
	  <h4>Payment<span class="col_red">  Gateway</span></h4>
      <div class="footer_1i1 row mt-4">
	   <div class="col-md-6 col-6">
	    <div class="footer_1i1i">
		  <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a class=" avitot active" aria-current="page" href="#" data-bs-toggle="modal" data-bs-target="#login-modal"><img src="images/51.png" height="70" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		</div>
	   </div>
	   <div class="col-md-6 col-6">
	    <div class="footer_1i1i">
		  <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a class=" avitot active" aria-current="page" href="#" data-bs-toggle="modal" data-bs-target="#login-modal"><img src="images/52.png" height="70" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		</div>
	   </div>
	  ...
	  <div class="footer_1i1 row mt-3">
	   ...
	   <div class="col-md-6 col-6">
	    <div class="footer_1i1i">
		  <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a class=" avitot active" aria-current="page" href="#" data-bs-toggle="modal" data-bs-target="#login-modal"><img src="images/53.png" height="70" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		</div>
	   </div>
	   <div class="col-md-6 col-6">
	    <div class="footer_1i1i">
		  <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a class=" avitot active" aria-current="page" href="#" data-bs-toggle="modal" data-bs-target="#login-modal"><img src="images/54.png" height="70" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		</div>
	   </div>
	...
	<div class="col-md-4" style="margin-top: 20px;">
	 <div class="footer_1i">
      ...
      <p class="mt-3" style="font-size: 13px;">Subscribe to our newsletter list to get latest news and updates from us</p>
	  <div class="input-group">
		...
		<ul class="social-network social-circle mb-0 mt-4">
			<li><a href="#" class="icoRss" title="Rss"><i class="fa-brands fa-instagram" style="font-size:25px;"></i></a></li>
			<li><a href="#" class="icoFacebook" title="Facebook"><i class="fa-brands fa-square-facebook" style="font-size:25px;"></i></a></li>
			<li><a href="#" class="icoTwitter" title="Twitter"><i class="fa-brands fa-twitter" style="font-size:25px;"></i></a></li>
			<li><a href="#" class="icoGoogle" title="Google +"><i class="fa-brands fa-square-twitter" style="font-size:25px;"></i></a></li>
			<li><a href="#" class="icoLinkedin" title="Linkedin"><i class="fa-brands fa-linkedin" style="font-size:25px;"></i></a></li>
		</ul>
	 </div>
	</div>
   </div>
...
<!--<section id="headerr" style="">-->
<!--<nav class="navbar navbar-expand-md navbar-light" id="navbar_sticky" style="position: fixed; width:100%; bottom: 0;z-index:999;background:#000;">-->
<!--  <div class="container-fluid" style="display: flex; margin:auto; padding: 0; justify-content:space-evenly;">-->
  	
    
<!--    <button class="navbar-toggler" onclick="location.href='https://dreamplay.me/'" target="_blank" type="button" data-bs-toggle="collapse" data-bs-target="#" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> -->
...
<!--    <button class="navbar-toggler" onclick="location.href='https://dreamplay.me/'" target="_blank" type="button" data-bs-toggle="collapse" data-bs-target="#" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> -->
<!--      <span class=""><i class="fa-solid fa-earth-africa"></i></span>-->
<!--    </button>-->
...
<!--    </button>-->
    ...
    <!--<div class="collapse navbar-collapse" id="navbarSupportedContent" style="background: #303026bd; border: 1px solid gray;  border-radius: 10px;">-->
...
<div class="container">
   <div class="row footer_1">
     <div class="col-md-3" style="color: grey;">
	  <div class="footer_1l">
	   <p class="mb-0"style="font-size: 13px;">www.dreamplay.me | All Rights Reserved </p>
	   <!--     <ul class="mb-0">-->
	   <!--    <li class="d-inline-block me-2"style="font-size: 13px; colour:#fff;"><a href="#">Terms & Conditions</a></li>-->
	   <!--    <li class="d-inline-block me-2"style="font-size: 13px;colour:#fff;"><a href="#">Privacy Policy</a></li>		-->
	   <!--</ul>-->
	  </div>
	 </div>
   </div>
